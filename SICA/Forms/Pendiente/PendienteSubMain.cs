...
{
    public partial class PendienteSubMain : Form
    {
        private IconButton currentBtn;
        private Panel topBorderBtn;
        private Form currentChildForm;

        public PendienteSubMain()
        {
        ...
        private void btRegularizar_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color4);
            OpenChildForm(new PendienteRegularizar());
        }
    }
}
