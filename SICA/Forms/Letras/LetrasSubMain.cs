...
{
    public partial class LetrasSubMain : Form
    {
        ...
        public LetrasSubMain()
        {
            ...
            btBuscar.Visible = int2bool(Globals.auLetraBuscar);
            btNuevo.Visible = int2bool(Globals.auLetraNuevo);
            btReingreso.Visible = int2bool(Globals.auLetraReingreso);
            btEntregar.Visible = int2bool(Globals.auLetraEntregar);
        }
        ...
        {
            ActivateButton(sender, RGBColors.color4);
            OpenChildForm(new LetrasBuscar());
        }
    }
}
