...
{
    public partial class MantenimientoSubMain : Form
    {
        private IconButton currentBtn;
        private Panel topBorderBtn;
        private Form currentChildForm;

        public MantenimientoSubMain()
        {
        ...
        private void btSocio_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color4);
            OpenChildForm(new MantenimientoSocio());
        }
