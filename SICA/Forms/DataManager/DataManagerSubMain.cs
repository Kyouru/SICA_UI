...
{
    public partial class DataManagerSubMain : Form
    {
        private IconButton currentBtn;
        private Panel topBorderBtn;
        private Form currentChildForm;

        public DataManagerSubMain()
        {
            InitializeComponent();
            ...
            btArmar.Visible = int2bool(Globals.auIronMountainArmar);
            btCargo.Visible = int2bool(Globals.auIronMountainCargo);
            btEntregar.Visible = int2bool(Globals.auIronMountainEntregar);
            btEnviar.Visible = int2bool(Globals.auIronMountainEnviar);
            btRecibir.Visible = int2bool(Globals.auIronMountainRecibir);
            btSolicitar.Visible = int2bool(Globals.auIronMountainSolicitar);
        ...
        private void btSolicitar_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new DataManagerSolicitar());
        }

        private void btRecibir_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color4);
            OpenChildForm(new DataManagerRecibir());
        }

        private void btArmar_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color4);
            OpenChildForm(new IronMountainArmar());
        }

        private void btEnviar_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color4);
            OpenChildForm(new DataManagerEnviar());
        }

        private void btEntregar_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color4);
            OpenChildForm(new IronMountainEntregar());
        }
